...
entry:
  ...
  %27 = bitcast %class.Int* 0 to %class.Object*
  store %class.Object* %27, %class.Object** %26, align 4
  %28 = getelementptr inbounds %class.E, %class.E* %this, i32 0, i32 6
  %29 = call noalias i8* @malloc(i64 8)
  %30 = bitcast i8* %29 to %class.IO*
  call void @_CN2IO_FN2IO_(%class.IO* %30)
  %31 = bitcast %class.IO* %30 to %class.Object*
  %32 = getelementptr inbounds %class.Object, %class.Object* %31, i32 0, i32 0
  %33 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.26, i32 0, i32 0
  store i8* %33, i8** %32, align 8
  %34 = bitcast %class.IO* %30 to %class.Object*
  store %class.Object* %34, %class.Object** %28, align 4
  %35 = getelementptr inbounds %class.E, %class.E* %this, i32 0, i32 7
  %36 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.16, i32 0, i32 0
  %37 = bitcast %class.String* %36 to %class.Object*
  store %class.Object* %37, %class.Object** %35, align 4
  %38 = getelementptr inbounds %class.E, %class.E* %this, i32 0, i32 8
  %39 = bitcast %class.Bool* 0 to %class.Object*
  store %class.Object* %39, %class.Object** %38, align 4
  %40 = getelementptr inbounds %class.E, %class.E* %this, i32 0, i32 9
  %41 = call noalias i8* @malloc(i64 8)
  %42 = bitcast i8* %41 to %class.IO*
  call void @_CN2IO_FN2IO_(%class.IO* %42)
  %43 = bitcast %class.IO* %42 to %class.Object*
  %44 = getelementptr inbounds %class.Object, %class.Object* %43, i32 0, i32 0
  %45 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.26, i32 0, i32 0
  store i8* %45, i8** %44, align 8
  store %class.IO* %42, %class.IO** %40, align 4
  %46 = getelementptr inbounds %class.E, %class.E* %this, i32 0, i32 10
  %47 = call noalias i8* @malloc(i64 12)
  %48 = bitcast i8* %47 to %class.A*
  call void @_CN1A_FN1A_(%class.A* %48)
  %49 = bitcast %class.A* %48 to %class.Object*
  %50 = getelementptr inbounds %class.Object, %class.Object* %49, i32 0, i32 0
  %51 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.0, i32 0, i32 0
  store i8* %51, i8** %50, align 8
  %52 = bitcast %class.A* %48 to %class.IO*
  store %class.IO* %52, %class.IO** %46, align 4
  %53 = getelementptr inbounds %class.E, %class.E* %this, i32 0, i32 11
  %54 = call noalias i8* @malloc(i64 16)
  %55 = bitcast i8* %54 to %class.C*
  call void @_CN1C_FN1C_(%class.C* %55)
  %56 = bitcast %class.C* %55 to %class.Object*
  %57 = getelementptr inbounds %class.Object, %class.Object* %56, i32 0, i32 0
  %58 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.2, i32 0, i32 0
  store i8* %58, i8** %57, align 8
  %59 = bitcast %class.C* %55 to %class.B*
  store %class.B* %59, %class.B** %53, align 4
  ret void
}
...
entry:
  ...
  %1 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.21, i32 0, i32 0
