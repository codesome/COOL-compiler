...
if.then.55:
  %3 = call noalias i8* @malloc(i64 16)
...
if.end.56:
  ...
  br i1 %6, label %if.then.57, label %if.else.57
...
if.end.57:
  ...
  br i1 %10, label %if.then.58, label %if.else.58
...
if.end.58:
  ...
  br i1 %14, label %if.then.59, label %if.else.59
...
if.end.59:
  ...
  br i1 %19, label %if.then.60, label %if.else.60
...
entry:
  ...
  %39 = call noalias i8* @malloc(i64 20)
  ...
  %44 = bitcast %class.F* %40 to %class.A*
  store %class.A* %44, %class.A** %38, align 4
  ret void
}
