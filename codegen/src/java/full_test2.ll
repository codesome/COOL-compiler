...
entry:
  ...
  br i1 %2, label %if.then.58, label %if.else.58
...
if.end.58:
  ...
  br i1 %6, label %if.then.59, label %if.else.59
...
if.end.59:
  ...
  br i1 %10, label %if.then.60, label %if.else.60
...
if.end.60:
  ...
  br i1 %14, label %if.then.61, label %if.else.61
...
if.end.61:
  ...
  br i1 %19, label %if.then.62, label %if.else.62
