...
@.str.3 = private unnamed_addr constant [28 x i8] c" , and appended new string
\00", align 1
...
entry:
  ...
  %4 = getelementptr inbounds [17 x i8], [17 x i8]* @.str.2, i32 0, i32 0
  ...
  %8 = getelementptr inbounds [28 x i8], [28 x i8]* @.str.3, i32 0, i32 0
  %9 = call i8* @_CN6String_FN6concat_(i8* %7, i8* %8)
...
entry:
  ...
  %1 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.8, i32 0, i32 0
