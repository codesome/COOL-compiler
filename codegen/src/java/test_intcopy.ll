; ModuleID = '../test_cases/test_intcopy.cl'
source_filename = "../test_cases/test_intcopy.cl"
...
%class.Main = type { %class.IO, %class.B*, %class.A* }
...
; Class: B, Method: f2
define i32 @_CN1B_FN2f2_(%class.B* %this, %class.A* %a) {

entry:
  %a.addr = alloca %class.A*, align 8
  store %class.A* %a, %class.A** %a.addr, align 8
  %0 = call noalias i8* @malloc(i64 12)
  ...
  store %class.A* %1, %class.A** %a.addr, align 8
  ret i32 0
}
...
entry:
  ...
  store %class.B* %3, %class.B** %1, align 4
  %7 = getelementptr inbounds %class.Main, %class.Main* %this, i32 0, i32 2
  %8 = call noalias i8* @malloc(i64 12)
  %9 = bitcast i8* %8 to %class.A*
  call void @_CN1A_FN1A_(%class.A* %9)
  %10 = bitcast %class.A* %9 to %class.Object*
  %11 = getelementptr inbounds %class.Object, %class.Object* %10, i32 0, i32 0
  %12 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.0, i32 0, i32 0
  store i8* %12, i8** %11, align 8
  store %class.A* %9, %class.A** %7, align 4
  ret void
}
